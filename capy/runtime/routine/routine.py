...
from capy.types.space import isany
from capy.runtime import error
from capy.runtime.routine.code_routine import CodeRoutine
from capy.runtime.routine.native_routine import NativeRoutine
...
def create_callback_routine(stack, on_result, on_complete, function, args):
    from capy.runtime.routine.callback_routine import CallbackRoutine
