from capy.types.root import W_Callable, W_Root
from capy.runtime.error import *
from capy.types import api, array
...
class W_Function(W_Callable):
    ...
    def _to_routine_(self, stack, args):
        from capy.runtime.routine.routine import create_function_routine
