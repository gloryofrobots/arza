...
IMPORT_NODES = [NT_IMPORT, NT_IMPORT_FROM, NT_IMPORT_FROM_HIDING, NT_IMPORT_HIDING]
...
INDENTS_CONSTRUCT = [TT_CONSTRUCT, TT_WHEN, TT_CASE, TT_ASSIGN] + INDENTS_CODE
...
INDENTS_TYPE = [TT_TYPE, TT_LPAREN, TT_CONSTRUCT]
