from lalan.types import api, space, plist, datatype
...
class Derived:
    ...
    def __init__(self, process):
        from lalan.runtime.load import import_module
    ...
    def postderive(self, process, module):
        from lalan.types import api, datatype
...
class Types:
    def __init__(self, symbols):
        from lalan.types.space import newnativedatatype as newtype
        _s = symbols.symbol
        # ---------------AUTOGENERATED---------------------
