...
#define OBIN_BEHAVIOR_COLLECTION(__iterator__,__length__,__getitem__,__hasitem__,__delitem__,__setitem__)  __iterator__, __length__, __getitem__, __hasitem__, __delitem__, __setitem__ 
