...
__NT_REPR__ = ["NT_GOTO", "NT_TRUE", "NT_FALSE", "NT_NIL", "NT_INT", "NT_FLOAT", "NT_STR", "NT_CHAR", "NT_WILDCARD",
               ...
               "NT_LOAD", "NT_TRAIT", "NT_IMPLEMENT", "NT_GENERIC", "NT_SPECIFY", "NT_BIND", "NT_THROW", "NT_BREAK",
               "NT_CONTINUE", "NT_FOR", "NT_WHILE", "NT_REST", "NT_ASSIGN", "NT_CALL", "NT_JUXTAPOSITION",
               "NT_UNDEFINE", "NT_LOOKUP", "NT_LOOKUP_SYMBOL", "NT_LOOKUP_MODULE", "NT_SLICE", "NT_RANGE", "NT_MODIFY",
