...
def builtin_compare_le_i_i(process, routine):
    from obin.builtins.internals.operations import compare_le_i_i
    arg1 = routine.get_arg(0)
    arg2 = routine.get_arg(1)
...
def builtin_compare_le_f_f(process, routine):
    from obin.builtins.internals.operations import compare_le_f_f
    arg1 = routine.get_arg(0)
    arg2 = routine.get_arg(1)
...
def builtin_compare_le_n_n(process, routine):
    from obin.builtins.internals.operations import compare_le_n_n
    arg1 = routine.get_arg(0)
    arg2 = routine.get_arg(1)
...
def builtin_compare_lt_i_i(process, routine):
    from obin.builtins.internals.operations import compare_lt_i_i
    arg1 = routine.get_arg(0)
    arg2 = routine.get_arg(1)
...
def builtin_compare_lt_f_f(process, routine):
    from obin.builtins.internals.operations import compare_lt_f_f
    arg1 = routine.get_arg(0)
    arg2 = routine.get_arg(1)
...
def builtin_compare_lt_n_n(process, routine):
    from obin.builtins.internals.operations import compare_lt_n_n
    arg1 = routine.get_arg(0)
    arg2 = routine.get_arg(1)
