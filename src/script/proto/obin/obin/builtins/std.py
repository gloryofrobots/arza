...
class Methods:
    def __init__(self, traits, symbols):
        ...
        # ---------------AUTOGENERATED---------------------
        # Eq
        self.eq =newmethod_hotpath(_s(u"eq"), traits.Eq,_l([_s(u"self"),_s(u"other"),]), hp.hp_eq)
        self.ne =newmethod_hotpath(_s(u"ne"), traits.Eq,_l([_s(u"self"),_s(u"other"),]), hp.hp_ne)
        # Ord
        self.gt =newmethod_hotpath(_s(u"gt"), traits.Ord,_l([_s(u"self"),_s(u"other"),]), hp.hp_gt)
        self.ge =newmethod_hotpath(_s(u"ge"), traits.Ord,_l([_s(u"self"),_s(u"other"),]), hp.hp_ge)
        self.le =newmethod_hotpath(_s(u"le"), traits.Ord,_l([_s(u"self"),_s(u"other"),]), hp.hp_le)
        self.lt =newmethod_hotpath(_s(u"lt"), traits.Ord,_l([_s(u"self"),_s(u"other"),]), hp.hp_lt)
        ...
        self.add =newmethod_hotpath(_s(u"add"), traits.Num,_l([_s(u"num"),_s(u"other"),]), hp.hp_add)
        self.sub =newmethod_hotpath(_s(u"sub"), traits.Num,_l([_s(u"num"),_s(u"other"),]), hp.hp_sub)
        self.mul =newmethod_hotpath(_s(u"mul"), traits.Num,_l([_s(u"num"),_s(u"other"),]), hp.hp_mul)
        self.div =newmethod_hotpath(_s(u"div"), traits.Num,_l([_s(u"num"),_s(u"other"),]), hp.hp_div)
        self.mod =newmethod_hotpath(_s(u"mod"), traits.Num,_l([_s(u"num"),_s(u"other"),]), hp.hp_mod)
        # Collection
        self.in_ =newmethod_hotpath(_s(u"in_"), traits.Collection,_l([_s(u"other"),_s(u"self"),]), hp.hp_in_)
        self.notin =newmethod_hotpath(_s(u"notin"), traits.Collection,_l([_s(u"other"),_s(u"self"),]), hp.hp_notin)
        # Seq
        self.cons =newmethod_hotpath(_s(u"cons"), traits.Seq,_l([_s(u"other"),_s(u"self"),]), hp.hp_cons)
        self.concat =newmethod_hotpath(_s(u"concat"), traits.Seq,_l([_s(u"self"),_s(u"other"),]), hp.hp_concat)
...
class Types:
    def __init__(self, symbols):
        ...
        self.Option = newtype(_s(u"Option"))
