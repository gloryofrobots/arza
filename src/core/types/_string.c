...
static OAny _obin_string_blank(OState* state, obin_mem_t length);
...
static OAny _obin_string_from_carr(OState* state, obin_string data, obin_mem_t size) {
 ...
 */
OAny obin_string_from_carray(OState* state, obin_string data,
obin_mem_t size) {
	/*empty string*/
	if (size == 0) {
