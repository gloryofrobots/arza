...
#define OBEHAVIOR_BASE(__tostring__,__tobool__,__clone__,__compare__,__equal__,__hash__)  __tostring__, __tobool__, __clone__, __compare__, __equal__, __hash__
